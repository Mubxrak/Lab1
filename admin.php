    ...
    <div class="my-auto upload-container">
        <form action="includes/gallery-helper.php" method="POST" enctype="multipart/form-data">
            <div class="form-group">
                <img src="images/alien.jpg" onclick="triggered();" id="gallery-display">
            ...
            <div class="form-group">
                <button type="submit" name="gallery-submit" class="btn-outline-success btn-lg btn-block">upload</button>
            </div>
        </form>
